...
const OrderTrackingPage = () => {
  ...
  if (!order) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="bg-white p-6 rounded-lg shadow-md text-center">
          <p className="text-gray-500 mb-4">{t("orderTracking.errors.orderNotFound")}</p>
          <Link to="/" className="btn btn-primary">
            {t("orderTracking.buttons.backToHome")}
          </Link>
        </div>
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
          <h2 className="text-lg font-bold text-gray-800 mb-4 flex items-center">
            <FaShoppingBag className="mr-2 text-purple-500" /> {t("orderTracking.items")} ({order.items.length})
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="font-bold text-gray-800">{t("orderTracking.shippingInfo")}</h3>
            </div>
            <div className="text-sm text-gray-600 space-y-2">
              ...
              <p>{t("orderTracking.phone")}: {order.shippingInfo.phone}</p>
              <p>{t("orderTracking.email")}: {order.shippingInfo.email}</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="font-bold text-gray-800">{t("orderTracking.paymentInfo")}</h3>
            </div>
            <div className="text-sm text-gray-600 space-y-2">
              <p>
          ...
          {/* Summary */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h3 className="font-bold text-gray-800 mb-4">{t("orderTracking.orderSummary")}</h3>
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span>{order.shipping === 0 ? t("orderTracking.free") : `$${order.shipping.toFixed(2)}`}</span>
              </div>
              <div className="flex justify-between">
